...
def get_data_frame_excel():
    ...
    #adicionando coluna hora
    df["Hour"] = pd.to_datetime(df["Time"], format="%H:%M:%S").dt.hour
    return df

df = get_data_frame_excel()
...
fig_product_sales = px.bar(
    ...
    orientation="h",
    title="<b>Vendas por Tipo de Produto</b>",
